                ...
                <div class="container">
                    <div class="owl-carousel owl-theme blog-post">
                        ...
                        <div class="blog-content" data-aos="fade-in" data-aos-delay="200">
                            <img src="Main Page/assets/harryjr.jpg" alt="post-1">
                            <div class="blog-title">
                                <h3>Nama Anak Pangeran Harry dan Meghan Markle Dianggap Merendahkan</h3>
                                <a href="MainpageLife(6).php"><button class="btn btn-blog">Baca</button></a>
                                
                            </div>
                        </div>
                        <div class="blog-content" data-aos="fade-left" data-aos-delay="200">
                            <img src="Main Page/assets/kalori.jpg" alt="post-1">
                            <div class="blog-title">
                                <h3>Cara Mudah Kurangi Asupan Kalori, Cobalah Makan Pelan-pelan</h3>
                                <a href="MainpageLife(11).php"><button class="btn btn-blog">Baca</button></a>
                ...
                <div class="posts">
                    <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <div class="post-title">
                            ...
                            <a href="MainpageLife(7).php"><button class="btn post-btn">Baca &nbsp; <i class="fas fa-arrow-right"></i></button></a>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
                        <div class="post-image">
                            <div>
                                <img src="Main Page/assets/susu.jpg" class="img" alt="blog1">
                            </div>
                            <div class="post-info flex-row">
                                <span><i class="fas fa-user text-gray"></i>&nbsp;&nbsp;Admin</span>
                                <span><i class="fas fa-calendar-alt text-gray"></i>&nbsp;&nbsp;May 21, 2021</span>
                        ...
                        <div class="post-title">
                            ...
                            <a href="MainpageLife(8).php"><button class="btn post-btn">Baca &nbsp; <i class="fas fa-arrow-right"></i></button></a>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
                        <div class="post-image">
                            <div>
                                <img src="Main Page/assets/lapar.jpg" class="img" alt="blog1">
                            </div>
                            <div class="post-info flex-row">
                                <span><i class="fas fa-user text-gray"></i>&nbsp;&nbsp;Admin</span>
                                <span><i class="fas fa-calendar-alt text-gray"></i>&nbsp;&nbsp;May 21, 2021</span>
                        ...
                        <div class="post-title">
                            <a href="MainpageLife(9).php">Mengapa Rasa Lapar Bisa Menyebabkan Kemarahan?</a>
                            <p>Tempe dan tahu merupakan makanan olahan dari kedelai.</p>
                            <a href="MainpageLife(9).php"><button class="btn post-btn">Baca &nbsp; <i class="fas fa-arrow-right"></i></button></a>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <div class="post-title">
                            ...
                            <a href="MainpageLife(10).php"><button class="btn post-btn">Baca &nbsp; <i class="fas fa-arrow-right"></i></button></a>
                        </div>
                    </div>
                </div>
