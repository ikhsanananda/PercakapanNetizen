...
<head>
    ...
    <title>Resep Mie Gomak Kuah Khas Batak untuk Sarapan</title>
                ...
                <div class="posts">
                    <div class="post-content" data-aos="zoom-in" data-aos-delay="200">
                        ...
                        <a href="MainpageFood(9).php">Resep Mie Gomak Kuah Khas Batak untuk Sarapan</a>
                            ...
                            <p>Rasa mi gomak bakal lebih nikmat dan otentik kalau menggunakan andaliman, merica khas Batak. Namun, merica pun dapat digunakan kalau tak tersedia andaliman.</p>
                            <p>Kamu dapat membuat mi gomak dari mi lidi atau spageti. Sementara, bumbunya dapat kamu blender agar praktis.</p>
                            <p>Ingin tahu cara membuat mi gomak yang simpel? Ikuti langsung resep dari Instagram @my.foodplace berikut.</p>
                            <a>Resep mi gomak khas Batak</a>
                            <p><b>Bahan (1-2 porsi)</b></p>
                            <p>
                                <ul>
                                    <li>250 gram mi lidi </li>
                                    <li>500 ml santan cair </li>
                                    <li>1 ruas lengkuas </li>
                                    <li>1/2 buah labu siam, iris korek api </li>
                                    <li>1 lembar daun salam </li>
                                    <li>1 lembar daun jeruk </li>
                                    <li>1 batang serai </li>
                                    <li>1 batang daun bawang, cincang </li>
                                    <li>Merica bubuk dan garam secukupnya </li>
                                </ul>
                            </p>
                            <p><b>Bumbu halus </b></p>
                            <p>
                            ...
                            <a>Cara membuat mi gomak khas Batak </a>
                            <p>
                                <ol>
                                    <li>Rebus mi lidi selama lebih kurang 10 menit. Angkat dan tiriskan.</li>
                                    <li>Tumis bumbu halus, serai, daun salam, dan daun jeruk. Tuang santan sambil aduk bumbu. Masukkan labu siam, aduk rata.</li>
                                    <li>Beri garam dan merica. Koreksi rasa. Sesaat sebelum diangkat, masukkan daun bawang.</li>
                                    <li>Letakkan mi lidi di atas piring, siram dengan kuah secukupnya. Sajikan bersama telur rebus.</li>
                                </ol>
                            </p>
                        </div>
                    </div>
